  ...
  render() {
    ...
    return (
      <section className="container">
        <div className="s-columnOne pull-left">
          <div className="s-storeLogo">
            ...
            <a
              href={`${this.props.uroot}${this.props.storeName.replace(
                / /g,
                "-"
              )}`}
            >
          ...
          <a href="/orjah/logout" className="s-logoutBtn">
            Logout
          </a>
        </div>
      </section>
